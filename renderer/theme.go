...
// gridRowInteractiveClass is Phase 1701's row-action affordance marker on a
// data-bound grid row.
//
...
// base class string.
func gridRowInteractiveClass(hasRowAction bool) string {
	if hasRowAction {
		return " fuaran-grid-row-interactive"
	}
	return ""
}
