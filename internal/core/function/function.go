// Package function is the Core twin behind the internal/core boundary: the
// signature-searchable function registry (findBySignature, compose), the
// capability model with its InvocationKey, and the capability declaration codec.
// The public github.com/fuaran-ui/fuaran-go/function package forwards to it; see
// that package for the full documentation.
package function
