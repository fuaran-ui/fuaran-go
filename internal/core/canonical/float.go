// Package canonical is the Core twin of the canonical-JSON encoding primitives
// (number form, key order, string escaping), behind the internal/core boundary.
// The public github.com/fuaran-ui/fuaran-go/canonical package forwards to it; see
